...
For example an app may have a messaging section that is used in one place. This section is very small/simple, is currently repeated twice and looks something like this - *example will be in the context of a frontend framework (Angular/React pseudocode)*.
