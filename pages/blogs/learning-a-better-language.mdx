...
I think it would also be nice to have the language help out a bit - I also do a lot of work Typescript and using this is feels a little better.

<br />

I can create things like interfaces and variable/return types. The problem is you can also assign *"any"* and dip out of the type system altogether.
