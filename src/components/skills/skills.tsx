...
const Skills: React.FC<Props> = ({
	...
	return (
		<div id="skills" className="py-4">
			...
			<div className="p-9 text-3xl justify-around flex w-auto h-auto">
				<div className="hover:text-yellow-300">{icon1}</div>
				<div className="hover:text-blue-400">{icon2}</div>
				<div className="hover:text-green-800">{icon3}</div>
			...
			<div className="p-9 text-3xl justify-around flex w-auto h-auto">
				...
				<div className="hover:text-green-800">{icon10}</div>
			</div>
			<div className="p-9 text-3xl justify-around flex w-auto h-auto">
			...
			<div className="p-9 text-3xl justify-around flex w-auto h-auto">
				...
				<div className="hover:text-red-400">{icon24}</div>
			</div>
			{/* desired skills */}
			...
			<div className="p-9 text-3xl justify-around flex w-auto h-auto">
				...
				<div className="hover:text-gray-600">{icon23}</div>
			</div>
		</div>
	);
};
